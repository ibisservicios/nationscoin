...
unlocked to sign the Nationscoin-Qt.app bundle.
...
allowing somebody to distribute a Nationscoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the nationscoin-qt.exe file inside the installer had not been tampered with.
