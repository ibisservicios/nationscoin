...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("nationscoin-ext-ip");
...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Nationscoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"nationscoin.unpo.org", "nationscoin.unpo.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Nationscoin is probably already running."), addrBind.ToString().c_str());
        else
